...
export function CredentialsSection(): React.JSX.Element {
  const educationList = [
    { level: 'ELEMENTARY SCHOOL', school: 'Alegria Elementary School' },
    { level: 'JUNIOR HIGH SCHOOL', school: 'Cordova Catholic Cooperative School' },
    { level: 'SENIOR HIGH SCHOOL', school: 'Cordova Catholic Cooperative School' },
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-16">
          {educationList.map((item, index) => (
            <div
              key={index}
              className="p-5 border border-slate-800 bg-slate-900/50 rounded-lg hover:border-cyan-500/50 transition-colors"
            >
